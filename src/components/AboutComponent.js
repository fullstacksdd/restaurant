...
function RenderLeaderItem({ item }) {
    return(
        <Media key={item.id} >
            <Media className="co-12 col-md-2">
        ...
        <div className="container">
            ...
            <div className="row row-content">
                <div className="col-12 col-md-6">
                    ...
                    With it&#39;s unique brand of world fusion cuisine that can be found nowhere else, it enjoys patronage from the A-list clientele in Hong Kong.  
